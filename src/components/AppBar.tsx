...
export const AppBar: React.FC = () => {
  ...
  return (
    <div>
      {/* NavBar / Header */}
      <div className="navbar flex h-20 flex-row md:mb-2 bg-white bg-opacity-50 shadow-lg text-neutral-content border-b border-zinc-800">
        ...
        <div className="navbar-end">
          <div className="hidden md:inline-flex align-items-center justify-items gap-6">
            ...
            <NavElement label="Mint" href="/mint" navigationStarts={() => setIsNavOpen(false)} />
            <NavElement label="Explorer" href="/explorer" navigationStarts={() => setIsNavOpen(false)} />

            <NavElement label="Swap Food" href="/swapfood" navigationStarts={() => setIsNavOpen(false)} />
